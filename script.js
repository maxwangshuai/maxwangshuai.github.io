...
function getTranslations() {
    return {
        zh: {
            ...
            'app4-privacy-intro': '时光记非常注重用户隐私保护，本隐私政策将告知您我们如何收集、使用和保护与时间记录相关的数据。',
            'app4-privacy-collect-title': '收集哪些信息',
            'app4-privacy-collect-desc': '我们不收集可识别您个人身份的信息（如姓名、手机号、邮箱、位置等），仅收集您在本App中主动记录的时间、精力及相关使用数据，这些数据仅用于实现本App核心功能。',
            'app4-privacy-use-title': '如何使用您的数据',
            'app4-privacy-use-desc': '我们主要在您的设备本地使用这些数据，用于生成统计图表、展示小组件和导出CSV等功能。在您主动开启AI分析等智能功能时，相关数据可能会通过加密方式发送至受信任的服务进行模型推理，仅用于为您生成分析与建议，不会用于与本功能无关的目的。',
            // 标签
            'tag-filmmaking': '影视制作',
        ...
        'auto-theme-label': '🕐 自动',
            ...
            'app4-privacy-effective-date': '生效日期：2026年2月9日',
            ...
            'app4-privacy-section1-2-list': '<li>用于生成清晰可视图表，为您展示时间分配与精力变化情况；</li><li>在您使用AI分析等智能功能时，用于向模型提供必要的上下文，从而为您生成时间与精力优化建议（相关数据会通过安全通道发送至服务端，仅用于提供该功能）；</li><li>用于实现小组件、灵动岛的数据展示，方便您快速查看核心信息；</li><li>用于支持CSV文件导出功能，为您提供数据备份与自主管理便利；</li><li>用于实现时间成就养成功能，记录您的使用进度与成果。</li>',
            'app4-privacy-section2-title': '二、数据存储',
            'app4-privacy-section2-intro': '在正常使用下，本App的用户数据主要存储在您的设备本地或您个人的云端空间中，您对自身数据拥有完全控制权。对于需要联网的功能（例如AI分析），为实现相应服务，相关数据可能会通过加密方式发送至服务端进行处理。具体存储方式如下：',
            ...
            'app4-privacy-section5-list': '<li><strong>本地数据加密：</strong>iOS端使用系统Keychain加密存储数据，防止设备被非法访问时的数据泄露；</li><li><strong>传输安全：</strong>当您使用依赖网络的功能（如AI分析）时，相关数据通过加密通道进行传输，并仅用于提供相应服务；</li><li><strong>设备安全适配：</strong>若检测到您的设备处于越狱状态，将提示您存在数据安全风险，建议您在非越狱设备上使用本App，进一步保障数据安全；</li><li><strong>技术防护：</strong>持续优化App安全性能，防范恶意攻击、数据窃取等安全风险。</li>',
            ...
            'app4-terms-title': 'TimeLog AI 使用条款',
            'app4-terms-h1': 'TimeLog AI 使用条款和用户协议',
            'app4-terms-effective-date': '生效日期：2026年2月9日',
            'app4-terms-intro': '欢迎使用 TimeLog AI（以下简称“本App”）。为保障您的合法权益，请在订阅或继续使用本App前，仔细阅读并理解本《使用条款和用户协议》。您在本App内订阅 TimeLog Pro 会员或继续使用本App，即视为您已阅读、理解并同意本协议的全部内容。',
            'app4-terms-section1-title': '一、适用范围与协议关系',
            'app4-terms-section1-content': '本协议约束您（个人用户）使用 TimeLog AI 及其提供的全部功能（包括但不限于时间记录、精力管理、统计分析、CSV 导出、iCloud 同步、AI 分析等）。若您不同意本协议的任何条款，请不要订阅或使用 TimeLog Pro 会员服务，并立即停止使用本App。',
            'app4-terms-section2-title': '二、订阅服务说明',
            'app4-terms-section2-intro': 'TimeLog Pro 会员属于自动续费订阅服务，由 Apple 通过您的 Apple ID 帐户统一管理和扣费。本App本身不直接处理任何支付信息。',
            'app4-terms-section2-list': '<li>订阅类型包含（以实际显示为准）：年度会员、季度会员、月度会员等。</li><li>订阅价格以 App Store 展示为准，例如：年度会员 ¥68.00/年，季度会员 ¥38.00/季，月度会员 ¥15.00/月（如有调整，以 Apple 审核通过后的价格为准）。</li><li>订阅一经确认购买，即由您的 Apple ID 帐户进行扣费。</li>',
            'app4-terms-section3-title': '三、自动续订与取消',
            'app4-terms-section3-list': '<li>除非您在当前订阅周期结束前至少 24 小时在系统“设置”中手动关闭自动续订，否则订阅将自动续期。</li><li>续订费用将在当前订阅周期结束前 24 小时内，由 Apple 自动从您的 Apple ID 帐户扣除。</li><li>您可以在 iOS 设备中进入“设置 &gt; Apple ID &gt; 订阅”中，查看和管理订阅，并可随时关闭自动续订。</li><li>已生效的订阅周期无法提前取消或按比例退款，订阅到期后自动失效。</li>',
            'app4-terms-section4-title': '四、使用规范',
            'app4-terms-section4-list': '<li>本App及 TimeLog Pro 会员仅供您本人在合法、合规的前提下使用。</li><li>您不得对本App进行逆向工程、反编译、破解、恶意攻击或用于任何非法用途。</li><li>您不得将本App或订阅服务用于转售、出租、出借或其他商业再分发行为。</li>',
            'app4-terms-section5-title': '五、数据与隐私',
            'app4-terms-section5-intro': '本App非常重视您的隐私和数据安全，并遵守您所在地区适用的隐私相关法律法规。',
            'app4-terms-section5-list': '<li>本App不收集可识别您个人身份的信息，所有时间记录、精力数据、操作记录及成就数据主要存储在您的设备本地或您个人的 iCloud 帐户中。</li><li>在您使用AI分析等智能功能时，相关数据可能会通过加密方式发送至受信任的服务进行处理，仅用于为您生成分析结果和建议，不会用于与该功能无关的目的。</li><li>关于数据收集、使用与存储的详细说明，请参阅本App的《隐私政策》。</li>',
            'app4-terms-section6-title': '六、服务变更、中断与终止',
            'app4-terms-section6-list': '<li>为提升产品体验或配合法律法规更新，我们可能对本App的功能进行优化、调整或升级。</li><li>在合理范围内，我们有权根据运营需要暂停、终止某些功能或服务，并通过产品更新说明、公告等方式提示您。</li><li>若因不可抗力、系统故障、第三方服务问题等导致服务中断或数据丢失，我们将在合理范围内协助您排查，但不对由此产生的损失承担赔偿责任。</li>',
            'app4-terms-section7-title': '七、免责声明',
            'app4-terms-section7-list': '<li>本App旨在帮助您更好地管理时间与精力，但不对具体结果（如成绩提升、工作绩效、生活变化等）作出保证。</li><li>由于设备原因、系统环境、网络状况或第三方服务变更等引起的使用受限或数据问题，本App在法律允许的范围内不承担相关责任。</li>',
            'app4-terms-section8-title': '八、协议更新',
            'app4-terms-section8-content': '随着本App功能迭代或相关法律法规的调整，我们可能会对本使用条款进行修订。更新后的条款将在本页面或App内以适当方式提示您。若您在条款更新后继续使用本App或继续保留订阅服务，即视为您同意修订后的条款；若您不同意，可停止使用本App并在系统设置中取消订阅。',
            'app4-terms-section9-title': '九、联系我们',
            'app4-terms-section9-intro': '若您对本使用条款或订阅服务有任何疑问、建议，或需要协助处理相关问题，可通过以下方式联系我们：',
            'app4-terms-section9-contact': '联系邮箱：cotree@foxmail.com',
            'app4-terms-section9-reply': '我们将在收到您的反馈后，尽快为您回复并处理。',
        ...
        'auto-theme-label': '🕐 Auto',
            ...
            'app4-privacy-effective-date': 'Effective Date: February 9, 2026',
            ...
            'app4-privacy-section1-2-list': '<li>To generate clear visual charts showing your time allocation and energy changes;</li><li>When you use AI analysis or similar intelligent features, to provide necessary context to the model so it can generate optimization suggestions for you (relevant data is transmitted securely and used only for providing this feature);</li><li>To implement data display for widgets and Dynamic Island, making it convenient for you to quickly view core information;</li><li>To support the CSV file export function, providing you with data backup and autonomous management convenience;</li><li>To implement the time achievement development function, recording your usage progress and results.</li>',
            'app4-privacy-section2-title': 'II. Data Storage',
            'app4-privacy-section2-intro': 'Under normal use, user data of this App is primarily stored locally on your device or in your personal cloud space, and you have full control over it. For features that require network connectivity (such as AI analysis), certain data may be securely transmitted to servers to provide the requested service. The specific storage methods are as follows:',
            ...
            'app4-privacy-section5-list': '<li><strong>Local Data Encryption:</strong> iOS uses system Keychain to encrypt and store data, helping prevent data leakage when the device is illegally accessed;</li><li><strong>Secure Transmission:</strong> When you use network-dependent features (such as AI analysis), relevant data is transmitted via encrypted channels and used only for providing the requested service;</li><li><strong>Device Security Adaptation:</strong> If your device is detected to be in a jailbroken state, you will be alerted to data security risks. It is recommended to use this App on non-jailbroken devices to further ensure data security;</li><li><strong>Technical Protection:</strong> We continuously optimize App security to prevent malicious attacks, data theft, and other security risks.</li>',
            ...
            'app4-terms-title': 'TimeLog AI Terms of Use',
            'app4-terms-h1': 'TimeLog AI Terms of Use and User Agreement',
            'app4-terms-effective-date': 'Effective Date: February 9, 2026',
            'app4-terms-intro': 'Welcome to TimeLog AI (hereinafter referred to as "this App"). To protect your rights, please read and fully understand this Terms of Use and User Agreement before subscribing or continuing to use this App. By subscribing to TimeLog Pro or continuing to use this App, you are deemed to have read, understood, and agreed to all terms of this Agreement.',
            'app4-terms-section1-title': 'I. Scope and Relationship of This Agreement',
            'app4-terms-section1-content': 'This Agreement governs your (an individual user) use of TimeLog AI and all features it provides, including but not limited to time tracking, energy management, statistical analysis, CSV export, iCloud sync, and AI analysis. If you do not agree to any part of this Agreement, please do not subscribe to or use TimeLog Pro and stop using this App.',
            'app4-terms-section2-title': 'II. Subscription Service Description',
            'app4-terms-section2-intro': 'TimeLog Pro is an auto-renewable subscription managed and billed by Apple through your Apple ID account. This App does not process any payment information directly.',
            'app4-terms-section2-list': '<li>Subscription types may include annual, quarterly, and monthly plans (subject to what is actually shown in the App).</li><li>Subscription prices are subject to the display in the App Store, for example: monthly membership $1.99/month, quarterly $5.99/quarter, annual $9.99/year (if adjusted, subject to the price approved by Apple).</li><li>Once you confirm the purchase, the fee will be charged to your Apple ID account.</li>',
            'app4-terms-section3-title': 'III. Auto-Renewal and Cancellation',
            'app4-terms-section3-list': '<li>Unless you manually turn off auto-renewal in system Settings at least 24 hours before the end of the current subscription period, the subscription will be automatically renewed.</li><li>The renewal fee will be charged to your Apple ID account within 24 hours before the end of the current subscription period.</li><li>You can go to Settings &gt; Apple ID &gt; Subscriptions on your iOS device to view and manage subscriptions and turn off auto-renewal at any time.</li><li>An active subscription period cannot be canceled early or refunded on a pro-rata basis. The subscription will remain effective until the end of the period.</li>',
            'app4-terms-section4-title': 'IV. Acceptable Use',
            'app4-terms-section4-list': '<li>This App and TimeLog Pro membership are provided solely for your personal, lawful, and compliant use.</li><li>You may not perform reverse engineering, decompilation, cracking, malicious attacks, or use this App for any illegal purposes.</li><li>You may not resell, rent, lend, or otherwise redistribute this App or the subscription service for commercial purposes.</li>',
            'app4-terms-section5-title': 'V. Data and Privacy',
            'app4-terms-section5-intro': 'We highly value your privacy and data security and comply with applicable privacy-related laws and regulations in your region.',
            'app4-terms-section5-list': '<li>This App does not collect personally identifiable information. All time logs, energy data, operation records, and achievement data are primarily stored locally on your device or in your personal iCloud account.</li><li>When you use AI analysis or similar intelligent features, relevant data may be transmitted via encrypted channels to trusted services for model inference, and is used only to generate analysis results and suggestions for you, not for purposes unrelated to this feature.</li><li>For more details about data collection, use, and storage, please refer to the Privacy Policy of this App.</li>',
            'app4-terms-section6-title': 'VI. Service Changes, Suspension, and Termination',
            'app4-terms-section6-list': '<li>To improve product experience or comply with laws and regulations, we may optimize, adjust, or upgrade the features of this App.</li><li>Within a reasonable scope, we may suspend or terminate certain features or services as needed and will notify you via release notes, in-app messages, or other appropriate means.</li><li>If service interruptions or data issues are caused by force majeure, system failures, or third-party service problems, we will assist you in troubleshooting within a reasonable scope, but will not be liable for any losses arising therefrom.</li>',
            'app4-terms-section7-title': 'VII. Disclaimer',
            'app4-terms-section7-list': '<li>This App is designed to help you better manage your time and energy, but it does not guarantee specific results such as grade improvement, work performance, or life changes.</li><li>Within the limits permitted by law, we are not responsible for usage limitations or data issues caused by device problems, system environment, network conditions, or changes in third-party services.</li>',
            'app4-terms-section8-title': 'VIII. Updates to This Agreement',
            'app4-terms-section8-content': 'As this App evolves or relevant laws and regulations change, we may revise this Terms of Use. The updated Agreement will be presented on this page or within the App in an appropriate manner. If you continue to use this App or maintain your subscription after the update, you are deemed to have agreed to the revised terms. If you do not agree, you may stop using this App and cancel the subscription in system settings.',
            'app4-terms-section9-title': 'IX. Contact Us',
            'app4-terms-section9-intro': 'If you have any questions or suggestions regarding this Terms of Use or the subscription service, or need assistance with data-related issues, please contact us via:',
            'app4-terms-section9-contact': 'Contact Email: cotree@foxmail.com',
            'app4-terms-section9-reply': 'We will reply and handle your feedback as soon as possible after receiving it.',
